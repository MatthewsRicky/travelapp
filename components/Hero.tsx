...
const Hero = () => {
	return (
		<section className='max-container video-background padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row'>
			<video
				autoPlay
				loop
				muted>
			...
			<h1 className='relative z-20 bold-52 lg:bold-88'>Diani Beach Podcast</h1>
