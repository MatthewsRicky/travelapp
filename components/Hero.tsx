...
const Hero = () => {
	return (
		<section className='relative z-100 max-container video-background padding-container flex flex-col justify-center items-center gap-6 py-10'>
			<video
				autoPlay
				loop
				muted>
			...
			<div className='relative flex flex-col'>
				<div className='justify-around items-center relative mx-auto bg-blue-100/20 flex z-20 sm:w-[85%] flex-col sm:flex-row gap-4 px-3 py-3 rounded-lg shadow-2xl'>
