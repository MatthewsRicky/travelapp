...
const Hero = () => {
	return (
		<section className='max-container video-background padding-container flex flex-col gap-8 py-10 pb-32 md:gap-28 lg:py-20'>
			<video
				autoPlay
				loop
				muted>
			...
			<h1 className='w-[30%] flex justify-center items-center relative z-20 bold-32 lg:bold-52 lg:w-[30%] lg:mx-auto my-4 px-4 py-6 rounded-md mt-6 text-center bg-blue-700/70 text-blue-200 shadow-lg'>
				Diani Beach Podcast
			</h1>
