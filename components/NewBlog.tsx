          ...
          <div className="my-20">
            <h1 className="flex items-center justify-center w-full uppercase bold-20 border-b-1 border-solid my-4">blog</h1>
              {BLOG_SECTION.map((blog)=>(
                <div key={blog.title} className="flexCenter md:padding-container shadow-md shadow-slate-900 gap-4 p-4 mb-6">
                  ...
                  <div className="flex flex-col md:flex-row gap-2">
                    <div className="flex flex-col items-center gap-3"> 
                      <h2 className="medium-48 mx-auto flexCenter uppercase shadow-xs shadow-slate-900/50 text-center px-2 py-3 my-4">{blog.title}</h2>
