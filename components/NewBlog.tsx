...
const NewBlog = ({src, alt, title, description}: blogItems) => {
  return(
        <div className="flex flex-col items-center justify-center mx-auto w-full my-20 bg-gradient-to-b from-orange-50/50 to-orange-200/50 text-slate-900 tracking-wide">
          ...
          <div key={blog.title} className="flexCenter flex-col md:padding-container mb-6">
            <div className="flexStart gap-x-4 items-center">
              <span className="flex p-4 items-center">
                <BsBookmarkFill className="w-6 h-5 text-slate-900 drop-shadow-lg drop-shadow-sky-800 p-6 border-neutral-700-solid" />
              </span>
